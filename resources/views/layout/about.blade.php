          ...
          <div class="flex flex-wrap">
            <div class="w-full px-4 mb-10 lg:w-1/2">
              ...
              >
                ...
                <h2
                  class="font-bold text-dark text-3xl mb-5 max-w-md lg:text-4xl text-white"
                >
                  Who Am I ?
                </h2>
                <p
                  class="font-medium text-base text-slate-500 max-w-xl lg:text-lg"
                >
            ...
            <div class="w-full px-4 lg:w-1/2">
              ...
              >
                <h3
                  class="font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-10 text-white"
                >
                  Stay Connect
                </h3>
                ...
                <div class="flex items-center">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    class="invert hover:invert-0 w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-cyan-700 hover:bg-cyan-700 hover-white border-slate-100"
                    ><img
                  ...
                  ><a
                    ...
                    rel="noreferrer"
                    class="invert hover:invert-0 w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-cyan-700 hover:bg-cyan-700 hover-white border-slate-100"
                    ><img src="/icons/github.svg" alt="Github" width="20" /></a
                  ><a
